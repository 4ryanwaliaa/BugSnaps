...
export const metadata: Metadata = {
  ...
  description:
    "BugSnaps Personal finds every account and listing tied to your identity across 100+ platforms, then helps you delete them — consent-first, using only official platform flows. Start with a free scan.",
  openGraph: {
